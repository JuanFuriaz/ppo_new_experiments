...
from contin_infomax.models import InfoMax, RacingcarMultiviewDataset
from pytorch_lightning.logging import TensorBoardLogger
from pytorch_lightning.callbacks import ModelCheckpoint
from contin_infomax.utils import init_weights
...
if __name__ == "__main__":
    ...
    parser = InfoMax.add_model_specific_args(parser)
    # parse params
    ...
    if os.path.isfile("%s/train_stack%d.pt" % (hparams.datadir, hparams.img_stack)) and \
        ...
        RacingcarMultiviewDataset.save_train_test_split(hparams.datapath, seed=hparams.seed, img_stack=hparams.img_stack)
